...
```{julia}
kbetw = ConScape.betweenness_kweighted(h, 
                distance_transformation=x -> exp(-x/80))
ConScape.heatmap(kbetw, yflip=true, title="Betweenness",color=cgrad(:viridis))
...
ConScape.plot_values(g, surv_prob[:,1], title="Survival proximity")
```
